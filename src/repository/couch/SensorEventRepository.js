...
var SensorEventRepository = /** @class */ (function () {
    ...
    SensorEventRepository.prototype._select = function (id, ignore_binary, sensor_spec, from_date, to_date, limit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Bootstrap_1.Database.use("sensor_event").find({
                            selector: {
                                "#parent": id,
                                sensor: sensor_spec,
                    ...
                    case 1:
                        all_res = (_a.sent()).docs.map(function (x) {
                            ...
                            return (__assign(__assign({}, x), { _id: undefined, _rev: undefined, "#parent": undefined }));
                        });
    ...
    SensorEventRepository.prototype._insert = function (participant_id, objects) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Bootstrap_1.Database.use("sensor_event").bulk({
                            docs: objects.map(function (x) {
                                ...
                                return ({
                                    ...
                                    data: (_a = x.data) !== null && _a !== void 0 ? _a : {}
                                });
                            })
                        })];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Bootstrap_1.Database.use("sensor_event").bulk({
                                docs: objects
                            })];
                    case 1:
                        _a.sent();
