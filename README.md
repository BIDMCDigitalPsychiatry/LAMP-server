...
| `DB`  | :heavy_check_mark:  | The connection string to the mongo or documentdb database, username, password, and connection parameters included.  |
| `DB_KEY`   |   |   |
...
| `ROOT_KEY`   | :heavy_check_mark:  | A randomly generated **hex** string (eg, from `openssl rand -hex 32`). Used by the application for encrypting and decrypting data. |
